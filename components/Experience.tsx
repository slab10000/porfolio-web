...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-24 relative overflow-hidden bg-swiss-lime">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-8">
          {EXPERIENCES.map((exp, index) => (
            <div 
              key={index} 
              className="group glassmorphism-premium py-12 px-8 rounded-3xl transition-all duration-500 ease-out"
            >
               {/* Header Row */}
